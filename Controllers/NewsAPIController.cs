...
namespace NewsApp.Controllers
{
    ...
    public class NewsAPIController : ControllerBase
    {
        ...
        private string EmailSend(PaymentModel Paymentdata)
        {
            ...
            smtp.EnableSsl = true;
            smtp.Credentials = new NetworkCredential("durgeshpandey239@gmail.com", "ieoe ixva fryy tagt");

            String from = "durgeshpandey239@gmail.com";
            String to = "dpd@narola.email";
        ...
        public ActionResult EmailSend(string name)
        {
                ...
                String messageBody = "Hello this is Durgesh Pandey ";
                MailMessage message = new MailMessage(from, to, subject, messageBody);
